...
Spawn a `cavecrew-builder` subagent for this phase. Do NOT wait for Phase 4 to start — launch both Phase 3 and Phase 4 subagents concurrently.
...
Spawn a `cavecrew-reviewer` subagent for this phase, concurrently with Phase 3.
...
**Wait for both Phase 3 and Phase 4 subagents to complete before proceeding.**
